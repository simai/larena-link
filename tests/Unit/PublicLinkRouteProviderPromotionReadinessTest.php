...
assert_true($report['checks']['public_runtime_route_not_promoted_yet']['status'] === 'passed', 'Public runtime route must remain unpromoted.');
assert_true($report['checks']['public_runtime_route_not_promoted_yet']['provider_promotion_enabled_now'] === false, 'Provider promotion must remain disabled.');
