...
assert(str_contains($configSource, "'name' => 'larena.public-link-runtime-hardening.resolve'"));
...
assert(str_contains($routeSource, "'larena.public-link-runtime-hardening.resolve'"));
