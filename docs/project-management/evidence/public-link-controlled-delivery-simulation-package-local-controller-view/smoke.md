...
```bash
PATH=/Applications/ServBay/package/bin:$PATH /Applications/ServBay/package/bin/php artisan route:list --path=larena/internal/public-link-controlled-delivery-simulation
```

Result:

- package quality gate passed;
- root route list confirms `/larena/internal/public-link-controlled-delivery-simulation`;
