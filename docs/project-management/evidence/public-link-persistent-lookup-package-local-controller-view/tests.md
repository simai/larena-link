...
- `PATH=/Applications/ServBay/package/bin:$PATH /Applications/ServBay/package/bin/php artisan test --filter=PublicLinkPersistentLookupFoundationTest`: passed, 7 tests, 92 assertions.
...
- `composer run validate:entry-app-presentation-debt-inventory`: passed with `public_link=29`, `tracked_file_count=122`, `unclassified_file_count=0`.
