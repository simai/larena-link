...
PATH=/Applications/ServBay/package/bin:$PATH /Applications/ServBay/package/bin/php artisan test --filter=FileManagerLinkSharingRuntimePreviewSmokeTest
...
- Package quality gate passed with lint, PHPStan, metadata/evidence/scope checks and the package unit suite, including `FileManagerLinkSharingRuntimePreviewTest`.
- Root smoke passed: `FileManagerLinkSharingRuntimePreviewSmokeTest`, 2 tests, 50 assertions.
