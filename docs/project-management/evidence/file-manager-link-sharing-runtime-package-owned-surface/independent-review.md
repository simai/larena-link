...
already-computed checks and a redacted safe trace from the entry app. It does
not import entry-app, filesystem or file-manager runtime classes.
...
Verdict: approved for package-owned read-model evidence.
